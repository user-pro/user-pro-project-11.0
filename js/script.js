...
const popupCloseIcon = document.querySelectorAll('.popup__close');   // КЛАСС ЗАКРЫТИЯ
...
function bodyLock() {
   ...
   body.classList.add('_lock');					   //КЛАСС LOCK НА BODY
...
function bodyUnLock() {
   setTimeout(function () {
      ...
      body.classList.remove('_lock');				//УДАЛИТЬ КЛАСС LOCK НА BODY
   }, timeout);
